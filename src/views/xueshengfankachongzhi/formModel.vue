				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="卡号" prop="kahao">
							<el-input class="list_inp" v-model="form.kahao" :readonly="true" placeholder="卡号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="充值金额" prop="chongzhijine">
							<el-input class="list_inp" v-model.number="form.chongzhijine" placeholder="充值金额"
								 type="number" 								:readonly="!isAdd||disabledForm.chongzhijine?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chongzhijine'){
					form.value.chongzhijine = row[x];
					disabledForm.value.chongzhijine = true;
					continue;
				}
